...
public class RedaoCommandoUnitTest {
    ...
    public static void setup() {
        ...
        rcommando = new RedaoCommando(redisClient);
        objs = rcommando.getPrimaryIndex("objs");
    }
    ...
    void getMultipleProperties() {
        ...
        Iterator<DaoValue> iter = values.iterator();
        Assertions.assertEquals("John Doe", iter.next().asString());
        Assertions.assertEquals(23, iter.next().asInt());
    }
